...
class GeneratedQuestion(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ...
            ["concepts.id"],
            ondelete="CASCADE",
            name="generated_questions_concept_id_fkey",
        ),
        PrimaryKeyConstraint("id", name="generated_questions_pkey"),
        Index(
            "idx_generated_questions_answer_key", "answer_key", postgresql_using="gin"
        ),
        Index("idx_generated_questions_concept", "concept_id"),
        Index(
            "idx_generated_questions_concept_source", "concept_id", "question_source"
        ),
